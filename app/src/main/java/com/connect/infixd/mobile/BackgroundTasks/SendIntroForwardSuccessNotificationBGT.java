...
public class SendIntroForwardSuccessNotificationBGT extends AsyncTask<String, Void, IntroNotifyResponse> {
    ...
    public SendIntroForwardSuccessNotificationBGT(Context ctx)
    {
        this.ctx = ctx;
    ...
    protected IntroNotifyResponse doInBackground(String... params) {
        ...
        IntroNotifyResponse introNotifyResponse = clientApi.notifyAcceptedForwardNotification(subjectId,intermediateId,targetId);
