...
public class FacebookLoginActivity extends InfixdBaseActivity implements
        ...
        mAuth.signInWithCredential(credential)
                ...
                .addOnFailureListener(e -> {
                    DialogFactory.getInstance().make(DialogFactory.REPORT_ERROR,
                            getCurrentFocus(), view -> { /* TODO: Handle report */}).show();
    ...
    private void updateFacebookDetails(AccessToken token){
        ...
        GraphRequest request = GraphRequest.newMeRequest(
                                ...
                                public void onCompleted(
                                    ...
                                    // Application code
                                    mDetailTextView.setText(response.getJSONObject().toString());
                    }
                });
